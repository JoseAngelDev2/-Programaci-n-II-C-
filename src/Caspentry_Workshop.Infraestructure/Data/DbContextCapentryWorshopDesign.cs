...
namespace Caspentry_Workshop.Infraestructure.Data
{
    public class DbContextCapentryWorshopDesign : IDesignTimeDbContextFactory<AppCarpentry> 
    {
          public AppCarpentry CreateDbContext(string[] args)
        {
            ...
            optionsBuilder.UseNpgsql("Host=aws-1-us-west-2.pooler.supabase.com;Database=postgres;Username=postgres.obcwgoqpwpxgxohlzdhs;Password=Uncle.com1424;SSL Mode=Require;Trust Server Certificate=true");
